...
// ShowSQL empty implementation
func (DiscardLogger) ShowSelectSQL(show ...bool) {}
...
// ShowSelectSQL implement core.ILogger
func (s *SimpleLogger) ShowSelectSQL(show ...bool) {
	if len(show) == 0 {
		s.showSelectSQL = true
		return
	}
	s.showSelectSQL = show[0]
}
